    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="index.html" class="navbar-brand mx-auto mx-lg-0">Rubrics</a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="images/prof.png" class="avatar-image avatar-image-large img-fluid" alt="">

                                    <h1 class="hero-title ms-3 mb-0">My name is Ruvic!</h1>
                                </div>

                                <h2 class="mb-4">I’m always available for you yieee.</h2>
                        ...
                        <div class="col-lg-5 col-12 position-relative">
                            ...
                            <img src="images/profile.png" class="hero-image img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/moon.jpg" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    ...
                                    <img src="images/prof.png" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">A little bit about me</h3>

                                <p>Gazing at the night sky, I dreamed of being an astronaut. I immersed myself in studying space, turning a childhood fascination into a determined goal. Despite doubts, I persevered through training and stood on the edge of a spacecraft, heart pounding.</p>

                                <p>The rocket launched, marking the realization of my journey from dreamer to astronaut. Looking down at Earth, I realized my dream wasn't just about space; it was proof that with dedication, even the biggest dreams can come true.</p>
                            </div>
                        </div>
                                ...
                                <div class="profile-body">
                                    ...
                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 305-240-9671">09655569432</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:hello@josh.design">ruvicalmoitebacton@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p class="mb-2">
                                        Ruvic is a professional web developer. Feel free to get in touch with me.
                              </p>
